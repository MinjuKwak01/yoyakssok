...
/**
 * 디바이스 토큰 API 컨트롤러 DDD Interface Layer 패턴 적용
 */
@RestController
...
public class DeviceTokenController {
    ...
    public ApiResponse<ApiResponse.SuccesCustomBody<Void>> registerDeviceToken(@Parameter(hidden = true) @AuthMember MemberInfo currentMember,
